#include "thumbsBrowser.h"

//--------------------------------------------------------------
void thumbsBrowser::refreshImage() {
	sourceImg.clear();
...
//--------------------------------------------------------------
bool thumbsBrowser::loadLUTaddon(std::string path)
{
...
//--------------------------------------------------------------
void thumbsBrowser::loadLUT(string path) {//OF example
	LUTloaded = false;
...
//--------------------------------------------------------------
void thumbsBrowser::applyLUT(ofPixelsRef pix) {
	if (LUTloaded) {
...
//--------------------------------------------------------------
void thumbsBrowser::keyReleased(int key) {

}

//--------------------------------------------------------------
void thumbsBrowser::keyPressed(int key) {
	switch (key) {
	case ' ':
		doLUT ^= true;
		break;
...
void thumbsBrowser::doExportThumb() {
	//apply
...
//--------------------------------------------------------------
void thumbsBrowser::refreshFiles() {
	dirThumbs.reset();
...
////--------------------------------------------------------------
//void thumbsBrowser::updateGui() {
//}

//--------------------------------------------------------------
void thumbsBrowser::draw_ImGui(int x, int y, int w, int h) {

	auto mainSettings = ofxImGui::Settings();
	ImGui::SetNextWindowPos(ImVec2(x, y), ImGuiCond_Always);
	ImGui::SetNextWindowSize(ImVec2(w, h), ImGuiCond_Always);
	//ImGui::Text("thumbsBrowser");
...
//--------------------------------------------------------------
void thumbsBrowser::processOpenFileSelection(ofFileDialogResult openFileResult) {
